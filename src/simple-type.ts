...
// Structure Types
// ##############################
export type SimpleTypeStructured = SimpleTypeUnion | SimpleTypeIntersection | SimpleTypeEnum

export function isSimpleTypeStructured(type: SimpleType): type is SimpleTypeStructured {
	return type.kind === "UNION" || type.kind === "INTERSECTION" || type.kind === "ENUM"
}
...
export type SimpleTypeObjectLike = SimpleTypeInterface | SimpleTypeClass | SimpleTypeObject

export function isSimpleTypeObjectLike(type: SimpleType): type is SimpleTypeObjectLike {
	return type.kind === "INTERFACE" || type.kind === "CLASS" || type.kind === "OBJECT"
}
...
export type SimpleTypeCallable = SimpleTypeFunction | SimpleTypeMethod

export function isSimpleTypeCallable(type: SimpleType): type is SimpleTypeCallable {
	return type.kind === "FUNCTION" || type.kind === "METHOD"
}
...
export function isSimpleType(type: unknown): type is SimpleType {
	return typeof type === "object" && type !== null && "kind" in type && Object.values(SIMPLE_TYPE_KINDS).find((key: SimpleTypeKind) => key === (type as { kind: SimpleTypeKind }).kind) !== undefined
}
